...
update achievements set description = 'Refer 10 developers to TG City'  where id = 'recruiter';
...
update achievements set description = 'Refer 30 developers to TG City'  where id = 'influencer';
update achievements set description = 'Refer 100 developers to TG City' where id = 'mayor';
