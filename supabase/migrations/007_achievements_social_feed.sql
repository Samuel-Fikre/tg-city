-- ============================================================
-- TG City v2 — Achievements, Social Interactions, Activity Feed
-- ============================================================
...
-- Social (referrals)
insert into achievements (id, category, name, description, threshold, tier, reward_type, reward_item_id, sort_order) values
  ('recruiter',   'social',  'Recruiter',   'Refer 3 developers to TG City',            3,     'bronze',  'unlock_item',     'helipad',         13),
  ('influencer',  'social',  'Influencer',  'Refer 10 developers to TG City',           10,    'gold',    'exclusive_badge',  null,              14),
  ('mayor',       'social',  'Mayor',       'Refer 50 developers to TG City',           50,    'diamond', 'exclusive_badge',  null,              15)
on conflict (id) do nothing;
